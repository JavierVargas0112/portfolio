                ...
                <div className="space-y-8">
                    ...
                    <div className="space-y-4 ">
                        ...
                        <p className="text-lg text-muted-foreground max-w-lg animate-fade-in animation-delay-200">
                            Étudiant Ingénieur en M1, passionné par le développement
                            Backend et l'analyse de données. Fort de mes compétences en
                            Node.js, React, Python et bases de données ,
                    ...
                    <div className="relative max-w-md mx-auto">
                        ...
                        <div className="relative glass rounded-3xl p-2 glow-border">
                            ...
                            <div className="absolute -top-4 -left-4 glass rounded-xl px-4 py-3 animation-delay-500">
                                <div className="text-2xl font-bold text-primary">Bac +4</div>
                                <div className="text-xs text-muted-foreground">Etudiant</div>
                            </div>
